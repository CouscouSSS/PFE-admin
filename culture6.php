...
$requete->execute(array($_SESSION['id'],5005,'Test Reussi'));
$ok=$requete->rowCount();
if($ok){
...
if($score == 10){
    ...
    $insert->execute(array($_SESSION['id'],5005,'Test Reussi'));
    $delete->execute(array('Test Pas Reussi',$_SESSION['id'],5005));
    ...
    exit();
        ...
        $res_fail = "EMM Dommage , vous pouvez réessayer ";
          ...
          $find->execute(array($_SESSION['id'],5005,'Test Pas Reussi'));
          $ok=$find->rowCount();
        if(!$ok){ 
          $insert=$bdd->prepare("INSERT INTO resultat(id_user,num,etat) VALUES(?,?,?)");
          $insert->execute(array($_SESSION['id'],5005,'Test Pas Reussi'));
        ...
        $updatereq->execute(array($_SESSION['id'],5005));
        $_SESSION['flash']['danger']=$res_fail ." <br> ".$resultat;
        }
      }
