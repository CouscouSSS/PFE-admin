        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class=" text-center pb-3 font-weight-bold mb-0 text-gray-800"> Voici la liste des administrateur dans votre site web
                        : </h3>
                    ...
                    <table class="table table-bordered text-center text-dark font-weight-bold" id="dataTable" width="100%" cellspacing="0">
                        <thead class="thead-dark ">
                            <tr>
                                ...
                                <th>Ajouté le: </th>
                                <th>Role</th>
                                <th>Suprimer l'administrateur</th>
                            </tr>
                        </thead>
