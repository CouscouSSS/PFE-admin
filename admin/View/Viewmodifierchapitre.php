                ...
                <div class="container-fluid">
                    ...
                    <?php else : ?>
                        ...
                        <form action="" method="POST" class="pt-3">
                            ...
                            <div class="form-group">
                                <button type="submit" name="update_chapitre" style="border-radius:100px;"
                                    class="btn btn-primary btn-user btn-block"> Modifier les informations du chapitre </button>
                            </div>
