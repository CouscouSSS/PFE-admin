        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 class="text-center pb-3 font-weight-bold mb-0 text-warning"> Ici vous pouvez ajouter un cours a
                        une section : </h2>
                    ...
                    <form method="POST" action="" >
                        ...
                        <div class="form-group">
                            <h3 class="font-weight-bold my-1 mr-2 text-dark" for="inlineFormCustomSelectPref">Choix de
                                la section pour y ajouter le cours : </h3>
                            <select name="section" class="custom-select my-1 mr-sm-2 w-100" id="inlineFormCustomSelectPref">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6 mb-3 mb-sm-0">
                                <h3 class="font-weight-bold my-1 mr-2 text-dark" for="inlineFormCustomSelectPref">Titre
                                    du cours : </h3>
                                <input type="text" name="titre" class="form-control form-control-user"
                                    placeholder="Entrez ici le titre du cours">
                                    <small class="pl-2"> Veuillez saisir un titre contenant des chiffres et lettre seulement </small>
                            </div>
                            <div class="col-sm-6">
                                <h3 class="font-weight-bold font-size my-1 mr-2 text-dark" for="inlineFormCustomSelectPref">Sous
                                    titre du cours (facultatif) : </h3>
                                <input type="text" name="sous_titre" class="form-control form-control-user"
                                    id="exampleRepeatPassword"
                                    placeholder="Entrez ici le sous titre du cours">
                                    <small class="pl-2"> Veuillez saisir un sous-titre contenant des chiffres et lettre seulement </small>
                            </div>

                        </div>

                        <div class="form-group">
                            <h3 class="font-weight-bold font-size my-1 mr-2 text-dark" for="inlineFormCustomSelectPref">Lien de
                                l'image ilustratif (facultatif) : </h3>
                            <input type="text" name="img" class="form-control form-control-user"
                                placeholder="Entrez ici l'image ilustratif du cours">
                                <small class="pl-2"> Veuillez entrez le lien vers l'image que vous voullez afficher </small>
                        </div>

                        <div class="form-group">
                        <button type="submit" name="add_course" style="border-radius:100px;"
                                class="btn btn-primary btn-user btn-block"> AJOUTER LE COURS </button>
                        </div>
