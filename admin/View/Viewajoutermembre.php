                ...
                <div class="container-fluid">
                    ...
                    <form action="" method="POST" >
                        ...
                        <div class="form-group">
                            <input type="text" name="name" class="form-control form-control-user" placeholder="Entre le nom de l'etudiant"
                        ...
                        <div class="form-group">
                            <button type="submit" name="add_account" style="border-radius:100px;"
                                class="btn btn-primary btn-user btn-block"> AJOUTER LE MEMBRE </button>
                        </div>
