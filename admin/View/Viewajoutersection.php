        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h2 class="text-center pb-3 font-weight-bold mb-0 text-warning" style="letter-spacing:2px;"> Ici vous pouvez ajouter une nouvelle section : </h2>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="form-group">
                            <h3 class="font-weight-bold font-size my-1 mr-2 text-dark" for="inlineFormCustomSelectPref"> Ajouter un nom a la section </h3>
                            <input type="text" name="nom" class="form-control form-control-user"
                                placeholder="Entrez ici le nom de la section">
                        </div>

                        <div class="form-group">
                            <h3 class="font-weight-bold font-size my-1 mr-2 text-dark" for="inlineFormCustomSelectPref"> Ajoute le niveau de la section </h3>
                            <input type="text" name="niveau" class="form-control form-control-user"
                                placeholder="Entrez ici le niveau de la section">
                        </div>

                        <div class="form-group">
                            <h3 class="font-weight-bold font-size my-1 mr-2 text-dark" for="inlineFormCustomSelectPref"> Ajouter l'objectif de la section </h3>
                            <textarea name="objectif" class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Ajouter ici l'objectif de la section"></textarea>
                        </div>

                        <div class="form-group">
                            <button type="submit" name="add_section" style="border-radius:100px;"
                                class="btn btn-primary btn-user btn-block"> AJOUTER LA SECTION </button>
                        </div>
