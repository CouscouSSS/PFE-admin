        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h3 class=" text-center pb-3 font-weight-bold mb-0 text-gray-800"> Voici la liste des sections
                    ...
                    <table class="table font-weight-bold text-center table-bordered " id="dataTable" width="100%"
                        cellspacing="0">
                        <thead class="thead-dark ">
                            <tr>
                                ...
                                <th style="vertical-align: middle;"> Suprimmer une section </th>
                            </tr>
                        </thead>
                        ...
                        <tr>
                            ...
                            <td style="vertical-align: middle;"> <a href="suprimersection.php?id=<?= $section['id']?>"> <button class="btn btn-outline-danger btn-lg"> Suprimer </button></a></td>
                        </tr>
                    ...
                    <div class="text-center">
                        <h1 class="display-3 text-dark"> Aucune section n'a été trouvé pour la recherche que vous avez
                            effectué </h1>
                        <a href="listesections.php"> <button class="btn btn-lg btn-outline-dark"> Revenir a la liste des
                                sections ? </button></a>
                    </div>
